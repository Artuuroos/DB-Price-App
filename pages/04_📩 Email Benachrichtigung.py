          ...
          if bahnkarteneu=="25 in der 2.Klasse":
              ...
              if bahnkarteneu=="50 in der 1.Klasse":
                ...
                if bahnkarteneu=="50 in der 2.Klasse":
                  ...
                  bahnkarte="0"
      st.write(start, ziel, datum, uhrzeit_stunde, uhrzeit_minuten, alter, bahnkarte, klasse)      
                          ...
                          if submit_buttonpreis:
                               ...
                               def Login(loginnn,loginpp): 
                                 ...
                                 if not cur.fetchone():  # An empty result evaluates to False.
                                     ...
                                     cur.execute("""SELECT login.passwort FROM login WHERE passwort=%s""", [loginpp])
                                     if not cur.fetchone():  # An empty result evaluates to False.
